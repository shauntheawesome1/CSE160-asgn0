...
class Vector3 {
  ...
  add(other) {
      ...
      var first_vector = this.elements;
      var second_vector = other.elements;
      for (var i = 0; i < 3; ++i) {
  ...
  static dot(other1, other2) {
      // Insert your code here.
      let dp = 0; // Modify this line to calculate this vector's magnitude.
      var first_vector = other1.elements;
      var second_vector = other2.elements;

      for(var i = 0; i < 3; ++i){
         dp += first_vector[i] * second_vector[i];
      }
  ...
  static cross(other1, other2) {
      ...
      v3.elements[0] = (first_vector[1]*second_vector[2]) - (first_vector[2]*second_vector[1]);
      v3.elements[1] = (first_vector[2]*second_vector[0] - (first_vector[0]*second_vector[2]));
      v3.elements[2] = (first_vector[0]*second_vector[1]) - (first_vector[1]*second_vector[0]);
  ...
  normalize() {
      ...
      for(var i = 0; i < 3; ++i){
         first_vector[i] = first_vector[i]/mag;
      }
